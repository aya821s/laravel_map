...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 text-center mt-3">
            <h3 class="pb-1">{{ $item->name }}の投稿</h3>
            @if ($posts->isEmpty())
                <p>投稿はありません。</p>
            @else
            <div id="posts">
                @foreach ($posts as $post)
                    <div class="card mb-2 main-card-bg">
                        <div class="row m-2">
                            <div class="col-sm-4 d-flex align-items-center px-0">
                            ...
                            <div class="col-sm-8 px-0">
                                ...
                                <div class="d-flex justify-content-center align-items-center ">
                                    ...
                                    @if ($post->is_soldout == 1)
                                        <p class="mb-0" style="color: red;">　売り切れです！</p>
                                    @endif
                                </div>
                                <div class="card-text">
                                    <p>{{ $post->description }}</p>
                                </div>
                                <div class="lh-sm d-flex justify-content-end align-items-center">
                                    <div class="text-secondary">
                                        <p class="mb-0 me-4">{{ $post->created_at->format('Y/m/d H:i') }}</p>
                                        @if ($post->is_anonymous !== 1)
                                            <p class="mb-0 me-4">by 匿名ユーザー</p>
                                        @else
                                            <p class="mb-0 me-4">by {{ $post->user->name }}</p>
                                        @endif
                                    </div>
                                    <div>
